...
public class SwiftDiskSpaceUpdatePlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "disk_space_update", binaryMessenger: registrar.messenger())
    let instance = SwiftDiskSpaceUpdatePlugin()
